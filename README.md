...
**[Hello World with webpack]** is a project that demonstrates the use of webpack to bundle JavaScript files and also show different word for greeting.
...
```sh
  cd my-folder
  git clone https://github.com/Hassaanjbaig-code/RoR-webpack.git
```
